...
class TicketChooseType extends React.Component {
  ...
  render() {
      const {seatName, departureCity, arrivalCity} = this.props
    return (
      <>
            ...
            <div className="ticket-form">
              <div className="ticket-field-1">Type</div>
                <div className="ticket-field-detail-2">
                  ...
                  <button className="adult-in-ticket" onClick = {this.chooseType} value = "CHILDREN">Children</button>
                  </div>
            </div>
            <div className="ticket-form">
...
export default withRouter(TicketChooseType);
