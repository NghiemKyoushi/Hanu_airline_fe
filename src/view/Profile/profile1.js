...
class Profile1 extends React.Component {
 ...
 async onSubmit(e) {
    ...
    const { id_card_number, credit_card_number, phoneNumber } = this.state;
    const body = {
      ...
      <>
      {
        ...
        >
          ...
          <div class="card">
            ...
            <h2 class="username">{user.user.username}</h2>
            ...
            <div class="actions">
              <div class="info">
                <h2>
                  <a >
                    <span>Email</span>
                    <small><input className = "edit-profile" placeholder = {user.user.email}></input></small>
                  </a>
                </h2>
              ...
              <div class="info">
                <h2>
                  <a >
                    <span>ID Card</span>
                    <small><input className = "edit-profile" 
                    placeholder = {user.id_card_number}
                  name="id_card_number"
                  onChange={this.handleChange}
                  style={{
                  }}
                ...
                <h2>
                  <a >
                    ...
                    <small><input className = "edit-profile" 
                    placeholder = {user.credit_card_number}
              ...
              <div class="cancel-btn">
                  <button className="cancel-btn-profile" onClick= { () => this.props.history.push("/profile")}>Cancel</button>
              </div>
            </div>
          </div>
        </section>
